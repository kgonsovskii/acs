...
begin
         ...
         glsfio.bidname2:=md2.FieldByName('myid').AsString;
         glsfio.name2:=md2.FieldByName('text').AsString;

         glsfio.bidname3:=md3.FieldByName('myid').AsString;
         glsfio.name3:=md3.FieldByName('text').AsString;
