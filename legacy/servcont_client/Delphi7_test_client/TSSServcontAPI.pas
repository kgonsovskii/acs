...
type
  ...
  PControllerChipInfoHdr = ^TControllerChipInfoHdr;
  TControllerChipInfoHdr = packed record
    Idx: Byte;
    Port: Byte;
    FC: Byte;
    SN: packed array [0..5] of Byte;
    IsFullInfo: Boolean;
  end;

  PControllerChipInfo = ^TControllerChipInfo;
  TControllerChipInfo = packed record
    Chan: Byte;
    Disconnected: Boolean;
    HasEvt: Boolean;
    Found: Boolean;
    RelayOnOnDisconnectInAuto: Boolean;
    RelayOnOnDisconnectInComplex: Boolean;
    TrackIsOn: Boolean;
    Bits: Byte;
    AbsntLimit: Byte;
    AbsntMax: Byte;
  ...
  PControllerChipInfo2 = ^TControllerChipInfo2;
  TControllerChipInfo2 = packed record
    Active: Boolean;
    OpenEvenComplex: Boolean;
    CheckCount: Byte;
    Port: Byte;
