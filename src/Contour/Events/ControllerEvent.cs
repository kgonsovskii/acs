namespace SevenSeals.Tss.Contour.Events;
    ...
    public class ControllerEvent : ChannelEvent
    {
        ...
        public const int Size = 16; // without CS
        ...
        public byte GetAddress() => _data[0];
        public ushort GetNo() => (ushort)((_data[9] << 8) | _data[8]);
        ...
        public DateTime GetControllerTimestamp() => _controllerTimestamp;
