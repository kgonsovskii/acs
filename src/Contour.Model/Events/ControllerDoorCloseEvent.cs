...
public class ControllerDoorCloseEvent : ControllerEvent
{
    public ControllerDoorCloseEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.DoorClose;
    }

    public ControllerDoorCloseEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.DoorClose;
    }
