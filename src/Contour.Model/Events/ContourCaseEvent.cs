...
public class ContourCaseEvent : ContourEvent
{
    public ContourCaseEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Case;
    }

    // Parameterless constructor for JSON deserialization
    public ContourCaseEvent() : base("", new byte[16])
    {
        Kind = KindEnum.Case;
    }
