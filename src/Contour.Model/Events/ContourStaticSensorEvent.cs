...
public class ContourStaticSensorEvent : ContourEvent
{
    public ContourStaticSensorEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.StaticSensor;
    }

    // Parameterless constructor for JSON deserialization
    public ContourStaticSensorEvent() : base("", new byte[16])
    {
        Kind = KindEnum.StaticSensor;
    }
    ...
    public override byte[] ToProtoData()
    {
        ...
        // Static sensor-specific data initialization
        protoData[17] = Data[3];
