...
public class ControllerRestartEvent : ControllerEvent
{
    public ControllerRestartEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Restart;
    }

    public ControllerRestartEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.Restart;
    }
