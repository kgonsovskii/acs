...
public class ControllerTimerEvent : ControllerEvent
{
    public ControllerTimerEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Timer;
    }

    public ControllerTimerEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.Timer;
    }
