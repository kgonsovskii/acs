...
public class ControllerCaseEvent : ControllerEvent
{
    public ControllerCaseEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Case;
    }

    public ControllerCaseEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.Case;
    }
