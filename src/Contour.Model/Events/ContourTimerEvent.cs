...
public class ContourTimerEvent : ContourEvent
{
    public ContourTimerEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Timer;
    }

    // Parameterless constructor for JSON deserialization
    public ContourTimerEvent() : base("", new byte[16])
    {
        Kind = KindEnum.Timer;
    }
