...
public class ContourStartEvent : ContourEvent
{
    public ContourStartEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Start;
    }

    // Parameterless constructor for JSON deserialization
    public ContourStartEvent() : base("", new byte[16])
    {
        Kind = KindEnum.Start;
    }
