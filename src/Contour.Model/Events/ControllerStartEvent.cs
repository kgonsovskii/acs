...
public class ControllerStartEvent : ControllerEvent
{
    public ControllerStartEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Start;
    }

    public ControllerStartEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.Start;
    }
