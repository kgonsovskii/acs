...
public class ControllerButtonEvent : ControllerEvent
{
    public ControllerButtonEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Button;
    }

    public ControllerButtonEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.Button;
    }
    ...
    public override byte[] ToProtoData()
    {
        ...
        // Button-specific data: isOpen = (base.Data[1] & 15) == 5
