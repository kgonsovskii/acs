...
public class ContourPower220VEvent : ContourEvent
{
    public ContourPower220VEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Power220V;
    }

    // Parameterless constructor for JSON deserialization
    public ContourPower220VEvent() : base("", new byte[16])
    {
        Kind = KindEnum.Power220V;
    }
