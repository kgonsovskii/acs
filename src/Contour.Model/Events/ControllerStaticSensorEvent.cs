...
public class ControllerStaticSensorEvent : ControllerEvent
{
    public ControllerStaticSensorEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.StaticSensor;
    }

    public ControllerStaticSensorEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.StaticSensor;
    }
