...
public class ControllerAutoTimeoutEvent : ControllerEvent
{
    public ControllerAutoTimeoutEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.AutoTimeout;
    }

    public ControllerAutoTimeoutEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.AutoTimeout;
    }
