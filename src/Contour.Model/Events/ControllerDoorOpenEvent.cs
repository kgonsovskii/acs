...
public class ControllerDoorOpenEvent : ControllerEvent
{
    public ControllerDoorOpenEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.DoorOpen;
    }

    public ControllerDoorOpenEvent(string channelId, byte[] evt, DateTime timestamp) : base(channelId, evt, timestamp)
    {
        Kind = KindEnum.DoorOpen;
    }
