...
public class ContourRestartEvent : ContourEvent
{
    public ContourRestartEvent(string channelId, byte[] evt) : base(channelId, evt)
    {
        Kind = KindEnum.Restart;
    }

    // Parameterless constructor for JSON deserialization
    public ContourRestartEvent() : base("", new byte[16])
    {
        Kind = KindEnum.Restart;
    }
